...
public class NaverActivity extends Activity {
     ...
     * client 정보를 넣어준다.
     */
    private static String OAUTH_CLIENT_ID = "QsVGlznTqFkGAqqr_QBN";
    private static String OAUTH_CLIENT_SECRET = "aAO2ufNQfo";
    private static String OAUTH_CLIENT_NAME = "nLogin";
    ...
    public void onButtonClick(View v) throws Throwable {
        ...
        switch (v.getId()) {
            case R.id.buttonOAuth: {
                mOAuthLoginInstance.startOauthLoginActivity(NaverActivity.this, mOAuthLoginHandler);
        ...
        protected void onPostExecute(String content) {
            try {
                ...
                if (object.getString("resultcode").equals("00")) {
                    ...
                    System.out.println("nickname:" + naverNickname);
